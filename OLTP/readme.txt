...
For transactions, the required fields are amount, operation type (replenishment, purchase/withdrawal) and date/time. It is possible to use "plus" or "minus" sign with amount instead of operation type.
