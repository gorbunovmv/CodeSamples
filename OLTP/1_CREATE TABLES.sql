...
CREATE TABLE Cards (
	...
	CONSTRAINT FK_Clients FOREIGN KEY (Card_Holder) REFERENCES Clients(Client_ID) 
)
...
CREATE TABLE Transactions (
	...
	CONSTRAINT FK_Cards FOREIGN KEY(Card_ID) REFERENCES Cards(Card_ID)
)
...
INSERT INTO Action_Types (Action_Type_Desc, [Sign])
VALUES	(N'IN', 1),
		(N'OUT', -1),
